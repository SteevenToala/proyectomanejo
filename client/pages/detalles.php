...
<html lang="en" class="h-100" data-bs-theme="auto">
  ...
  <body class="d-flex h-100 text-center background">
    ...
    <ul class="list-unstyled text-start">
      <li><strong>📅 Fecha:</strong> 20 al 22 de marzo de 2025</li>
      <li><strong>📍 Lugar:</strong> Estadio Bellavista, Ambato</li>
      <li><strong>🎤 Artistas:</strong> Morat, Natti Natasha, Juanes, Guardarraya, y más...</li>
      <li><strong>🎫 Entradas:</strong> Preventa desde el 15 de enero</li>
      <li><strong>🕒 Horario:</strong> Desde las 17h00 hasta las 2h00</li>
    </ul>
